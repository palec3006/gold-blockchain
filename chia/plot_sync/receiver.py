...
class Receiver:
    ...
    _staking_addresses: Dict[str, int]
    _staking_farmers: Dict[G1Element, str]

    def __init__(
        self,
        connection: WSGoldConnection,
        ...
        self._staking_addresses = {}
        self._staking_farmers = {}
    ...
    def reset(self) -> None:
        ...
        self._total_effective_plot_size = 0
        self._harvesting_mode = None
        self._staking_addresses.clear()

    def connection(self) -> WSGoldConnection:
    ...
    def staking_addresses(self) -> Dict[str, int]:
        return self._staking_addresses
    ...
    async def _process_loaded(self, plot_infos: PlotSyncPlotList) -> None:
        ...
        for plot_info in plot_infos.data:
            ...
            if plot_info.farmer_public_key in self._staking_farmers:
                puzzle_hash = self._staking_farmers[plot_info.farmer_public_key]
            else:
                puzzle_hash = create_puzzlehash_for_pk(plot_info.farmer_public_key).hex()
                self._staking_farmers[plot_info.farmer_public_key] = puzzle_hash
            if puzzle_hash not in self._staking_addresses:
                self._staking_addresses[puzzle_hash] = 1
            else:
                self._staking_addresses[puzzle_hash] += 1
    ...
    def to_dict(self, counts_only: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            "staking_addresses": self._staking_addresses,
        }
