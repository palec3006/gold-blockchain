...
class CacheEntry:
    ...
    def from_disk_prover(cls, prover: DiskProver) -> CacheEntry:
        ...
        local_public_key: G1Element = local_sk.get_g1()
        ...
        return cls(
            ...
            plot_public_key, time.time(), local_public_key,
        )
        ...
        try:
            ...
            if stored_cache.version == CURRENT_VERSION:
                ...
                for path, cache_entry in cache_data.entries:
                    ...
                    #       Related: - https://github.com/goldcoin-gl/gold-blockchain/issues/13084
                    ...
                    # https://github.com/goldcoin-gl/gold-blockchain/issues/16063
