...
# Version 1 includes the original limits for gold software from versions 1.0 to 1.4.
rate_limits = {
    1: {
        ...
        "rate_limits_other": {
            ...
            ProtocolMessageTypes.respond_coin_records_by_puzzle_hash: RLSettings(500, 1024 * 1024, 10 * 1024 * 1024),
        },
    },
    2: {
        "default_settings": RLSettings(100, 1024 * 1024, 100 * 1024 * 1024),
