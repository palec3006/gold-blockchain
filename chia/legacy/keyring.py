"""
Provides a helper to access the legacy keyring which was supported up to version 1.6.1 of gold-blockchain. To use this
...
DEFAULT_USER = f"user-gold-{CURRENT_KEY_VERSION}"  # e.g. user-gold-1.8
DEFAULT_SERVICE = f"gold-{DEFAULT_USER}"  # e.g. gold-user-gold-1.8
MAX_KEYS = 100
