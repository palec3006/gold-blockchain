...
SubEpochData = gold_rs.SubEpochData
...
SubEpochChallengeSegment = gold_rs.SubEpochChallengeSegment
SubEpochSegments = gold_rs.SubEpochSegments
SubSlotData = gold_rs.SubSlotData
