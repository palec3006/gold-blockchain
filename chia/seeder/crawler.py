...
class Crawler:
    ...
    async def create_client(
        self, peer_info: PeerInfo, on_connect: Callable[[WSGoldConnection], Awaitable[None]]
    ) -> bool:
    ...
    async def connect_task(self, peer: PeerRecord) -> None:
        ...
        async def peer_action(peer: WSGoldConnection) -> None:
            peer_info = peer.get_peer_info()
            version = gold_short_version(peer.get_version())
