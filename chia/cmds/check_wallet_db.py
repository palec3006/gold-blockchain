...
help_text = """
\b
    The purpose of this command is find potential issues in Gold wallet databases.
    The core gold client currently uses sqlite to store the wallet databases, one database per key.
\b
