    ...
    with lock_and_load_config(root_path, config_yaml, fill_missing_services=True) as config:
        ...
        if testnet:
            if testnet == "true" or testnet == "t":
                ...
                testnet_port = "54444"
                testnet_introducer = "introducer-testnet11.glcoin.net"
                testnet_dns_introducer = "dns-introducer-testnet11.glcoin.net"
                bootstrap_peers = ["testnet11-node-us-west-2.glcoin.net"]
                testnet = "testnet11"
                ...
                mainnet_port = "14444"
                mainnet_introducer = "introducer.glcoin.net"
                mainnet_dns_introducer = "dns-introducer.glcoin.net"
                bootstrap_peers = ["node.glcoin.net"]
                net = "mainnet"
