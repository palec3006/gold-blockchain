...
@click.option("--testnet", is_flag=True, help="Configure this gold install to connect to the testnet")
...
def init_cmd(
    ...
    - Get more details on remote harvester on Gold wiki:
      https://github.com/goldcoin-gl/gold-blockchain/wiki/Farming-on-many-machines
    """
...
if __name__ == "__main__":
    ...
    from .init_funcs import gold_init

    gold_init(DEFAULT_ROOT_PATH)
