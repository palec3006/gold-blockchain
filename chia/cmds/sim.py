...
@click.group("sim", help="Configure and make requests to a Gold Simulator Full Node")
@click.option(
    "-p",
    "--rpc-port",
    help=(
...
@sim_cmd.command("create", help="Guides you through the process of setting up a Gold Simulator")
...
@sim_cmd.command("start", help="Start service groups while automatically using the right gold_root.")
...
@sim_cmd.command("stop", help="Stop running services while automatically using the right gold_root.")
