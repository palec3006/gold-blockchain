...
@click.option(
    ...
    "-d",
    help=(
        "Show the first wallet address using non-observer derivation. Older Gold versions use "
...
@click.option("--prefix", "-x", help="Address prefix (gl for mainnet, tgl for testnet)", default=None, type=str)
@click.pass_context
def search_cmd(
    ctx: click.Context,
