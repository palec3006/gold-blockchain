...
def generate(shell: str) -> None:
    ...
    You can source it directly (performs slower) by running:
        \033[3;33meval "$(gold complete generate)"\033[0m
    or you can save the output to a file:
        \033[3;33mgold complete generate > ~/.gold-complete-bash\033[0m
    and source that file with:
        \033[3;33m. ~/.gold-complete-bash\033[0m
    """
    ...
    subprocess.run(["gold"], check=True, env={**os.environ, "_GOLD_COMPLETE": f"{shell}_source"})
