...
class WalletBlockchain(BlockchainInterface):
    ...
    async def add_block(self, block: HeaderBlock, difficulty_coeff: Decimal) -> Tuple[AddBlockResult, Optional[Err]]:
        ...
        required_iters, error = validate_finished_header_block(
            self.constants, self, block, False, difficulty, sub_slot_iters, difficulty_coeff, False
        )
