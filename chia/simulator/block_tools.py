...
import anyio
from gold_rs import ALLOW_BACKREFS, MEMPOOL_MODE, AugSchemeMPL, G1Element, G2Element, PrivateKey, solution_generator
...
class BlockTools:
    ...
    def __init__(
        ...
        if automated_testing:
            ...
            create_default_gold_config(root_path)
            create_all_ssl(
                root_path,
        ...
        try:
            if self.local_keychain:
                ...
                keychain_proxy = await connect_to_keychain_and_validate(
                    self.root_path, self.log, user="testing-1.8.0", service="gold-testing-1.8.0"
                )
            ...
            if len(self.pool_pubkeys) == 0 or len(self.farmer_pubkeys) == 0:
                raise RuntimeError("Keys not generated. Run `gold keys generate`")
            ...
            if passes_plot_filter(prefix_bits, plot_id, challenge_hash, signage_point):
                ...
                for proof_index, quality_str in enumerate(qualities):
                    ...
                    if required_iters < calculate_sp_interval_iters(constants, sub_slot_iters):
                        ...
                        if not isinstance(pool_public_key_or_puzzle_hash, G1Element):
...
# these are the costs of unknown conditions, as defined gold_rs here:
# https://github.com/Chia-Network/gold_rs/pull/181
