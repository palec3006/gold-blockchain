...
After `gold plots create` becomes obsolete, consider removing it from there.
"""
...
def get_chiapos_install_info() -> Optional[Dict[str, Any]]:
    ...
    return {"display_name": "Gold Proof of Space", "version": chiapos_version, "installed": True}


def plot_gold(args: Namespace, root_path: Path) -> None:
    try:
