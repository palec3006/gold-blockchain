...
import gold_rs
from gold_rs import G1Element, G2Element, compute_merkle_set_root
...
def create_unfinished_block(
    ...
    assert gold_rs.AugSchemeMPL.verify(proof_of_space.plot_public_key, cc_sp_hash, cc_sp_signature)
