...
Write-Output "Remove unused @gold-network packages to make cache slim"
...
# Remove `packages/gui/node_modules/@gold-network` because it causes an error on later `electron-packager` command
#Remove-Item "@gold-network" -Recurse -Force
