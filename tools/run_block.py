...
"""
run_block: Convert an encoded FullBlock from the Gold blockchain into a list of transactions
...
$ca_root is the directory containing your current Gold config files
