...
import click
import zstd
from gold_rs import MEMPOOL_MODE, AugSchemeMPL, G1Element, SpendBundleConditions, run_block_generator
...
# returns an optional error code and an optional SpendBundleConditions (from gold_rs)
