...
# https://github.com/goldcoin-gl/gold-blockchain/pull/10460#issuecomment-1054492495
...
if [ ! "$CI" ]; then
  ...
  # Set modified output of `gold version` to version property of GUI's package.json
