...
if [ "$(uname -m)" = "armv7l" ]; then
  ...
  echo "https://github.com/goldcoin-gl/gold-blockchain/wiki/Raspberry-Pi"
  echo "Exiting."
  exit 1
fi
# Get submodules
...
if [ "$PYTHON_MAJOR_VER" -ne "3" ] || [ "$PYTHON_MINOR_VER" -lt "7" ] || [ "$PYTHON_MINOR_VER" -ge "13" ]; then
  echo "Gold requires Python version >= 3.8 and  < 3.13.0" >&2
...
echo "https://discord.gg/glcoin"
echo ""
echo "Try the Quick Start Guide to running gold-blockchain:"
echo "https://github.com/goldcoin-gl/gold-blockchain/wiki/Quick-Start-Guide"
echo ""
