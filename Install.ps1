...
{
    Write-Output "Gold requires a 64-bit Windows installation"
    Exit 1
}
...
Write-Output ""
Write-Output "Try the Quick Start Guide to running gold-blockchain:"
Write-Output "https://github.com/goldcoin-gl/gold-blockchain/wiki/Quick-Start-Guide"
Write-Output ""
Write-Output "To install the GUI run '.\venv\scripts\Activate.ps1' then '.\Install-gui.ps1'."
Write-Output ""
Write-Output "Type '.\venv\Scripts\Activate.ps1' and then 'gold init' to begin."
